...
import addUserValidationWithoutSnowflakeValidation from './addUserValidationWithoutSnowflakeValidation';
...
class UserController {
  ...
  public addUser = async (req: Request, res: Response) => {
    addUserValidationWithoutSnowflakeValidation(req, res);
  };
